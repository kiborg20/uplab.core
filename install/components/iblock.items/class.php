...
class IblockItemsComponent extends CBitrixComponent
{
    ...
    /**
     * массив параметров для выбора по умолчанию
     *
     * @var string[]
     */
    ...
    protected function executeEpilog()
    {
        ...
        if ($this->arParams["SET_META"] == "Y") {
            ...
            if ($v = $this->arResult["SECTION"]["~IPROPERTY_VALUES"]["SECTION_META_DESCRIPTION"] ?? "") {
                $APPLICATION->SetPageProperty("description", strip_tags($v));
            }
        }
