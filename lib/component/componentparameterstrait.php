...
trait ComponentParametersTrait
{
	 ...
	 * ]
	 *
	 * В result_modifier.php вызывать примерно такой код:
	 *
	 * ```php
	 * if (($url = $arResult["COMPONENT_EDIT_URL"]) && ($areaId = $arResult["COMPONENT_EDIT_AREA_ID"])) {
	 *     $this->AddEditAction($areaId, $url, "Редактировать параметры компонента");
	 * }
	 * ```
	 */
