...
// region Фоллбэк для старых версий Twig (< 1.34)
if (!class_exists("\Twig\TokenParser\IncludeTokenParser")) {
	class_alias("Twig_TokenParser_Include", "\Twig\TokenParser\IncludeTokenParser");
}
if (!class_exists("\Twig\Token")) {
	class_alias("Twig_Token", "\Twig\Token");
}
// endregion