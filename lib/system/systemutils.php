...
class SystemUtils
{
	...
	/**
	 * Возвращает true, если текущая версия Битрикс не требует значение func_overload=2
	 *
	 * @noinspection PhpMissingReturnTypeInspection
	 */
	public static function checkIfBitrixWithoutOverload()
	{
		return CheckVersion(ModuleManager::getVersion("main"), "20.200.00");
	}

	/**
	 * Возвращает true, если текущая версия битрикс совместима с настройками сервера.
	 *
	 * Возвращает true, если:
	 *
	 * - либо если версия чувствительна к значению func_overload=2, и
	 * - либо если версия не требует func_overload (версия, новее, чем 20.200.260)
	 *
	 * @noinspection PhpMissingReturnTypeInspection
	 */
	public static function checkIfStringFunctionsWorkCorrectly()
	{
		if (static::checkIfBitrixWithoutOverload()) {
			return true;
		} else {
