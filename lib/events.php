...
class Events
{
	...
	public static function bindEvents()
	{
		...
		$event->addEventHandler("main", "OnBeforeLocalRedirect", [self::class, "prepareRedirectLogic"]);
	...
	public static function prepareRedirectLogic($url, $skipSecurityCheck, $isExternal)
	{
		$GLOBALS["DELAY_EXECUTE_REJECT"] = "Y";
	}
