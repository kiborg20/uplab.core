...
trait EventsTrait
{
	...
	public static function redirect404()
	{
		...
		if (defined("ERROR_404")) {
			// Если корневая директория - /ru/ или /en/,
			// а запрошена страница, не содержащая языковую версию,
			// добавляем SITE_DIR в начало
			if (defined("SITE_DIR") && SITE_DIR != "/" && !StringUtils::isStringStartsWith($curDir, SITE_DIR)) {
				LocalRedirect(SITE_DIR . substr($curDir, 1));
